...
interface BrotInterface extends ethers.utils.Interface {
  functions: {
    ...
    "c_0x00600ce3(bytes32)": FunctionFragment;
...
export class Brot extends BaseContract {
